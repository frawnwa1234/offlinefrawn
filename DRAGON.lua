...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/frawnwa12/offlinefrawn/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/frawnwa12/offlinefrawn/main/DRAGON.lua')
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/frawnwa12/offlinefrawn/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/frawnwa12/offlinefrawn/main/library')
os.execute('wget https://raw.githubusercontent.com/frawnwa12/offlinefrawn/main/File_Bot')
send(msg.chat_id_, msg.id_,'⋆ تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/frawnwa12/offlinefrawn/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/frawnwa12/offlinefrawn/main/File_Bot/"..file)
if res == 200 then
